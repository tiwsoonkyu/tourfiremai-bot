...
def get_recommendations(user_message: str, tour_data: str) -> str:
    ...
    resp = claude.messages.create(
        ...
        max_tokens=800,
        system=(
            "คุณคือน้องแอดมินของรวมทัวร์ไฟไหม้ ตอบภาษาไทย สั้น กระชับ น่ารัก ใช้ emoji บ้าง "
            "จากรายการทัวร์ที่ให้มา เลือก Top 3 ที่เหมาะกับลูกค้า "
            "ตอบแต่ละโปรแกรม: ชื่อ / จำนวนวัน / ราคา / วันเดินทาง / ลิงค์"
        ),
        messages=[{
            "role": "user",
